...
namespace UC_13_Henrique_Webssite.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public FornecedorsController(UC_13_Henrique_WebssiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,Nome,Email,CNPJ,Codigo,Expedicao,Data_De_Entrega,Responsavel,Receptor,PrecoBruto,Tipo,Quantidade,Estado,Cidade,CEP")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorId,Nome,Email,CNPJ,Codigo,Expedicao,Data_De_Entrega,Responsavel,Receptor,PrecoBruto,Tipo,Quantidade,Estado,Cidade,CEP")] Fornecedor fornecedor)
        {
