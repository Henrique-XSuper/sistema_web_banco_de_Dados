...
namespace UC_13_Henrique_Webssite.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(UC_13_Henrique_WebssiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,Nome,Sobrenome,CPF,Nascimento,Endereco,Cidade,Estado,CEP")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,Nome,Sobrenome,CPF,Nascimento,Endereco,Cidade,Estado,CEP")] Vendedor vendedor)
        {
